...
// var roomSrv = flag.String("room-server", "http://45.77.221.127:8080", "The origin of the room server")
var roomSrv = flag.String("room-server", "https://www.apprtc.club", "The origin of the room server")
